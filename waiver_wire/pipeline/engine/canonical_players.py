...
_HERE = os.path.dirname(os.path.abspath(__file__))  # waiver_wire/pipeline/engine
LOTTERY_BIN = os.path.join(_HERE, os.pardir, "bin")
if LOTTERY_BIN not in sys.path:
    sys.path.insert(0, LOTTERY_BIN)
SKILL_BIN = os.path.join(os.path.expanduser("~"), "workspace", "skills", "supabase-football-signal", "bin")
...
IDENTITY_SNAPSHOT = os.environ.get("IDENTITY_SNAPSHOT", os.path.join(
